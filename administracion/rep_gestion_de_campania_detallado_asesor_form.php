                        ...
                        <div class="row-fluid">
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    <div class="muted pull-left">Reporte de Gestión Detallada de Programa por Asesor</div>
                                </div>
                                <div class="block-content collapse in">
                                </div>
                                <form class="form-horizontal" id="frmgestionxprograma" name="formgestionasesor" method="post" action="rep_gestion_de_campania_detallado_asesor_procesar.php">
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <button type="reset" class="btn" onclick="location.href = 'rep_gestion_de_campania_detallado_asesor_form.php'">Cancelar</button>
                                    </div>
                                </form>
                            </div>
                        </div>
