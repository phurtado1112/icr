...
$consulta_subtipificacion = "SELECT * FROM subtipificacion where activo=1";
...
<html>
    <head>
        ...
        <title>Subtipificaciones Inactivas</title>
                                ...
                                <div class="block-content collapse in">
                                    <table class="table table-striped table-hover">                            
                                        ...
                                        if (!isset($subtipificacion)) {
                                            ...
                                            <?php
                                            foreach ($subtipificacion as $st) {
                                                $ids = $st['idtipificacion'];
                                                echo"
                                                    <tr>
                                                    <td>" . $st['idsubtipificacion'] . "</td>
                                                    <td>" . $st['subtipificacion'] . "</td>
                                                    <td>" . '<a href="subtipificacion_activar.php?idsubtipificacion=' . $ids . '">Activar</a>' . "</td>
                                                    </tr>";
                                            }
                                        }
                                        ?>
