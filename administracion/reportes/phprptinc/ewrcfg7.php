...
define("EWR_PROJECT_ID", "{FBAFD19E-E753-4738-84A0-8DC7FC3CBD41}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "Reportes_INCAE", TRUE); // Project Name
define("EWR_PROJECT_VAR", "Reportes_INCAE", TRUE); // Project Var
...
$EWR_LANGUAGE_FILE[] = array("es", "", "spanish.xml");
define("EWR_LANGUAGE_DEFAULT_ID", "es", TRUE);
...
define("EWR_CONN_USER", 'incaeu', TRUE);
define("EWR_CONN_PASS", 'incaeu1', TRUE);
define("EWR_CONN_DB", 'incaecrm', TRUE);
...
define("EWR_RANDOM_KEY", 'E740CzHV0Nvq6W8M', TRUE); // Random key for encryption
