...
$GestiF3n_CampaF1a_x_Asesor_Seminarios = NULL;

//
// Table class for Gestión Campaña x Asesor Seminarios
//
class crGestiF3n_CampaF1a_x_Asesor_Seminarios extends crTableBase {
...
//	var $SelectLimit = TRUE;
	...
	function __construct() {
		...
		$this->TableVar = 'GestiF3n_CampaF1a_x_Asesor_Seminarios';
		$this->TableName = 'Gestión Campaña x Asesor Seminarios';
		$this->TableType = 'REPORT';
		$this->ExportAll = TRUE;
		$this->ExportPageBreakCount = 0;

		// idasignar
		$this->idasignar = new crField('GestiF3n_CampaF1a_x_Asesor_Seminarios', 'Gestión Campaña x Asesor Seminarios', 'x_idasignar', 'idasignar', '`idasignar`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// asesor
		$this->asesor = new crField('GestiF3n_CampaF1a_x_Asesor_Seminarios', 'Gestión Campaña x Asesor Seminarios', 'x_asesor', 'asesor', '`asesor`', 200, EWR_DATATYPE_STRING, -1);
		...
		// idcampania
		$this->idcampania = new crField('GestiF3n_CampaF1a_x_Asesor_Seminarios', 'Gestión Campaña x Asesor Seminarios', 'x_idcampania', 'idcampania', '`idcampania`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// campania
		$this->campania = new crField('GestiF3n_CampaF1a_x_Asesor_Seminarios', 'Gestión Campaña x Asesor Seminarios', 'x_campania', 'campania', '`campania`', 200, EWR_DATATYPE_STRING, -1);
		...
		// terminada
		$this->terminada = new crField('GestiF3n_CampaF1a_x_Asesor_Seminarios', 'Gestión Campaña x Asesor Seminarios', 'x_terminada', 'terminada', '`terminada`', 200, EWR_DATATYPE_STRING, -1);
		...
		// fechainicio
		$this->fechainicio = new crField('GestiF3n_CampaF1a_x_Asesor_Seminarios', 'Gestión Campaña x Asesor Seminarios', 'x_fechainicio', 'fechainicio', '`fechainicio`', 133, EWR_DATATYPE_DATE, 7);
		...
		// fechafin
		$this->fechafin = new crField('GestiF3n_CampaF1a_x_Asesor_Seminarios', 'Gestión Campaña x Asesor Seminarios', 'x_fechafin', 'fechafin', '`fechafin`', 133, EWR_DATATYPE_DATE, 7);
		...
		// idprograma
		$this->idprograma = new crField('GestiF3n_CampaF1a_x_Asesor_Seminarios', 'Gestión Campaña x Asesor Seminarios', 'x_idprograma', 'idprograma', '`idprograma`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// programa
		$this->programa = new crField('GestiF3n_CampaF1a_x_Asesor_Seminarios', 'Gestión Campaña x Asesor Seminarios', 'x_programa', 'programa', '`programa`', 200, EWR_DATATYPE_STRING, -1);
		...
		// idusuario
		$this->idusuario = new crField('GestiF3n_CampaF1a_x_Asesor_Seminarios', 'Gestión Campaña x Asesor Seminarios', 'x_idusuario', 'idusuario', '`idusuario`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// nombre
		$this->nombre = new crField('GestiF3n_CampaF1a_x_Asesor_Seminarios', 'Gestión Campaña x Asesor Seminarios', 'x_nombre', 'nombre', '`nombre`', 200, EWR_DATATYPE_STRING, -1);
		...
		// tipo
		$this->tipo = new crField('GestiF3n_CampaF1a_x_Asesor_Seminarios', 'Gestión Campaña x Asesor Seminarios', 'x_tipo', 'tipo', '`tipo`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// activo
		$this->activo = new crField('GestiF3n_CampaF1a_x_Asesor_Seminarios', 'Gestión Campaña x Asesor Seminarios', 'x_activo', 'activo', '`activo`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// fechatrans
		$this->fechatrans = new crField('GestiF3n_CampaF1a_x_Asesor_Seminarios', 'Gestión Campaña x Asesor Seminarios', 'x_fechatrans', 'fechatrans', '`fechatrans`', 133, EWR_DATATYPE_DATE, 7);
		...
		// idtipificacion
		$this->idtipificacion = new crField('GestiF3n_CampaF1a_x_Asesor_Seminarios', 'Gestión Campaña x Asesor Seminarios', 'x_idtipificacion', 'idtipificacion', '`idtipificacion`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// idtipificaciontipo
		$this->idtipificaciontipo = new crField('GestiF3n_CampaF1a_x_Asesor_Seminarios', 'Gestión Campaña x Asesor Seminarios', 'x_idtipificaciontipo', 'idtipificaciontipo', '`idtipificaciontipo`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// ultimo
		$this->ultimo = new crField('GestiF3n_CampaF1a_x_Asesor_Seminarios', 'Gestión Campaña x Asesor Seminarios', 'x_ultimo', 'ultimo', '`ultimo`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// TOTAL
		$this->TOTAL = new crField('GestiF3n_CampaF1a_x_Asesor_Seminarios', 'Gestión Campaña x Asesor Seminarios', 'x_TOTAL', 'TOTAL', '`TOTAL`', 20, EWR_DATATYPE_NUMBER, -1);
		...
		// ATENDIDO
		$this->ATENDIDO = new crField('GestiF3n_CampaF1a_x_Asesor_Seminarios', 'Gestión Campaña x Asesor Seminarios', 'x_ATENDIDO', 'ATENDIDO', '`ATENDIDO`', 131, EWR_DATATYPE_NUMBER, -1);
		...
		// PENDIENTE
		$this->PENDIENTE = new crField('GestiF3n_CampaF1a_x_Asesor_Seminarios', 'Gestión Campaña x Asesor Seminarios', 'x_PENDIENTE', 'PENDIENTE', '`PENDIENTE`', 131, EWR_DATATYPE_NUMBER, -1);
		...
		// CALIFICADO
		$this->CALIFICADO = new crField('GestiF3n_CampaF1a_x_Asesor_Seminarios', 'Gestión Campaña x Asesor Seminarios', 'x_CALIFICADO', 'CALIFICADO', '`CALIFICADO`', 131, EWR_DATATYPE_NUMBER, -1);
		...
		// NOINTERESADO
		$this->NOINTERESADO = new crField('GestiF3n_CampaF1a_x_Asesor_Seminarios', 'Gestión Campaña x Asesor Seminarios', 'x_NOINTERESADO', 'NOINTERESADO', '`NOINTERESADO`', 131, EWR_DATATYPE_NUMBER, -1);
		...
		// OTROPROGRAMA
		$this->OTROPROGRAMA = new crField('GestiF3n_CampaF1a_x_Asesor_Seminarios', 'Gestión Campaña x Asesor Seminarios', 'x_OTROPROGRAMA', 'OTROPROGRAMA', '`OTROPROGRAMA`', 131, EWR_DATATYPE_NUMBER, -1);
		...
		// FALLIDA
		$this->FALLIDA = new crField('GestiF3n_CampaF1a_x_Asesor_Seminarios', 'Gestión Campaña x Asesor Seminarios', 'x_FALLIDA', 'FALLIDA', '`FALLIDA`', 131, EWR_DATATYPE_NUMBER, -1);
		...
		// Otras
		$this->Otras = new crField('GestiF3n_CampaF1a_x_Asesor_Seminarios', 'Gestión Campaña x Asesor Seminarios', 'x_Otras', 'Otras', '`Otras`', 131, EWR_DATATYPE_NUMBER, -1);
		...
		// PROCENT
		$this->PROCENT = new crField('GestiF3n_CampaF1a_x_Asesor_Seminarios', 'Gestión Campaña x Asesor Seminarios', 'x_PROCENT', 'PROCENT', '`PROCENT`', 131, EWR_DATATYPE_NUMBER, -1);
