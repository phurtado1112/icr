...
$idestado = filter_input(INPUT_GET, 'idestadoscliente');

$consulta_estado = "SELECT * FROM estadoscliente WHERE idestadoscliente='" . $idestado . "' ";
$lista_estado = bd_ejecutar_sql($consulta_estado);
$estado_conectado = bd_obtener_fila($lista_estado);

$id = $estado_conectado['idestadoscliente'];
$estado = $estado_conectado['estadocliente'];
?>
<!DOCTYPE html>
<html>
    ...
    <head>
        <meta charset="utf-8" />
        <title>Editar Estado de Cliente</title>
                        ...
                        <div class="row-fluid">
                            <div class="block">
                                ...
                                <div class="block-content collapse in">
                                    ...
                                    <form class="form-horizontal" action="estado_cliente_editar_procesar.php" name="formnnews" method="POST">
