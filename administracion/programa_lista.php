...
$consulta_programa = "SELECT * FROM programas where activo=0";
                        ...
                        <div class="row-fluid">
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    ...
                                    <a href="programa_crear.php" class="btn btn-small btn-success">Nuevo Programa</a>
                                    <a href="programa_inactivo.php" class="btn btn-small btn-success">Programas Inactivos</a>
                                </div>
