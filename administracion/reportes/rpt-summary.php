...
$<!--##=gsPageObj##-->->GrpIdx = ewr_InitArray(1, -1);
$<!--##=gsPageObj##-->->GrpIdx[0] = -1;
...
<!--## } ##-->
	...
	if (!$<!--##=gsPageObj##-->->ShowHeader && $<!--##=gsPageObj##-->->Export <> "") {
		echo "<span data-class=\"tpb" . $<!--##=gsPageObj##-->->GrpCount . "_<!--##=gsTblVar##-->\">&nbsp;</span>";
	}
	<!--## } ##-->
...
<!--## if (bGenFilter) { ##-->
			<a class="ewTableHeaderPopup" onclick="ewr_ShowPopup.call(this, event, '<!--##=sSessionFldVar##-->', <!--##=sUseRange##-->, '<?php echo $<!--##=sFldObj##-->->RangeFrom; ?>', '<?php echo $<!--##=sFldObj##-->->RangeTo; ?>');" id="<!--##=sFldVar##--><?php echo $<!--##=gsPageObj##-->->Cnt[0][0]; ?>"><span class="glyphicon glyphicon-filter"></span></a>
<!--## } ##-->
		</div>
<?php } else { ?>
...
<!--## } else { ##-->
	...
	$sSql = ewr_BuildReportSql($<!--##=gsPageObj##-->->SqlSelect(), $<!--##=gsPageObj##-->->SqlWhere(), $<!--##=gsPageObj##-->->SqlGroupBy(), $<!--##=gsPageObj##-->->SqlHaving(), $<!--##=gsPageObj##-->->SqlOrderBy(), $sWhere, $<!--##=gsPageObj##-->->Sort);
...
##-->
<?php if (<!--##=sFldCount##--> > 0) { ?>
		<td colspan="<?php echo (<!--##=sFldCount##-->) ?>"<?php echo $<!--##=sFldObj##-->->CellAttributes() ?>><!--##@RptSumHead##--> <?php echo $<!--##=sFldObj##-->->FldCaption() ?>: <!--##=sSmryPrefix##--><?php echo $<!--##=sFldObj##-->->GroupViewValue ?><!--##=sSmrySuffix##--> (<?php echo ewr_FormatNumber($<!--##=gsPageObj##-->->Cnt[<!--##=lvl##-->][0],0,-2,-2,-2) ?><!--##@RptDtlRec##-->)</td>
<?php } ?>
</tr>
<!--##
...
<!--## } else { // Detail view ##-->
	...
	<tr<?php echo $<!--##=gsPageObj##-->->RowAttributes(); ?>><td colspan="<?php echo ($<!--##=gsPageObj##-->->GrpFldCount + $<!--##=gsPageObj##-->->DtlFldCount) ?>"><!--##@RptPageTotal##--> (<?php echo ewr_FormatNumber($<!--##=gsPageObj##-->->Cnt[0][0],0,-2,-2,-2); ?><!--##@RptDtlRec##-->)</td></tr>
...
<!--## } else { // Detail view ##-->
	...
	<tr<?php echo $<!--##=gsPageObj##-->->RowAttributes(); ?>><td colspan="<?php echo ($<!--##=gsPageObj##-->->GrpFldCount + $<!--##=gsPageObj##-->->DtlFldCount) ?>"><!--##@RptGrandTotal##--> (<?php echo ewr_FormatNumber($<!--##=gsPageObj##-->->TotCount,0,-2,-2,-2); ?><!--##@RptDtlRec##-->)</td></tr>
...
<!--## } ##-->
	...
	##-->
		...
		$sSql = ewr_BuildReportSql($<!--##=sFldObj##-->->SqlSelect, $this->SqlWhere(), $this->SqlGroupBy(), $this->SqlHaving(), $<!--##=sFldObj##-->->SqlOrderBy, "", "");
