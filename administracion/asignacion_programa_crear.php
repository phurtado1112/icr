                        ...
                        <div class="row-fluid">
                            <div class="block">
                                ...
                                <div class="block-content collapse in">
                                    <form class="form-horizontal" action="asignacion_programa_crear_procesar.php" name="formasignacionprog" method="post">
                                        <fieldset>
                                            <legend>Ingresar Nueva Asignación Campaña a Programa</legend>
