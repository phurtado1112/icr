...
$Estado_de_CampaF1as_x_Asesor = NULL;

//
// Table class for Estado de Campañas x Asesor
//
class crEstado_de_CampaF1as_x_Asesor extends crTableBase {
...
//	var $SelectLimit = TRUE;
	...
	function __construct() {
		...
		$this->TableVar = 'Estado_de_CampaF1as_x_Asesor';
		$this->TableName = 'Estado de Campañas x Asesor';
		$this->TableType = 'REPORT';
		$this->ExportAll = TRUE;
		$this->ExportPageBreakCount = 0;

		// idasignar
		$this->idasignar = new crField('Estado_de_CampaF1as_x_Asesor', 'Estado de Campañas x Asesor', 'x_idasignar', 'idasignar', '`idasignar`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// idcampania
		$this->idcampania = new crField('Estado_de_CampaF1as_x_Asesor', 'Estado de Campañas x Asesor', 'x_idcampania', 'idcampania', '`idcampania`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// campania
		$this->campania = new crField('Estado_de_CampaF1as_x_Asesor', 'Estado de Campañas x Asesor', 'x_campania', 'campania', '`campania`', 200, EWR_DATATYPE_STRING, -1);
		...
		// terminada
		$this->terminada = new crField('Estado_de_CampaF1as_x_Asesor', 'Estado de Campañas x Asesor', 'x_terminada', 'terminada', '`terminada`', 200, EWR_DATATYPE_STRING, -1);
		...
		// fechainicio
		$this->fechainicio = new crField('Estado_de_CampaF1as_x_Asesor', 'Estado de Campañas x Asesor', 'x_fechainicio', 'fechainicio', '`fechainicio`', 133, EWR_DATATYPE_DATE, 7);
		...
		// fechafin
		$this->fechafin = new crField('Estado_de_CampaF1as_x_Asesor', 'Estado de Campañas x Asesor', 'x_fechafin', 'fechafin', '`fechafin`', 133, EWR_DATATYPE_DATE, 7);
		...
		// idprograma
		$this->idprograma = new crField('Estado_de_CampaF1as_x_Asesor', 'Estado de Campañas x Asesor', 'x_idprograma', 'idprograma', '`idprograma`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// programa
		$this->programa = new crField('Estado_de_CampaF1as_x_Asesor', 'Estado de Campañas x Asesor', 'x_programa', 'programa', '`programa`', 200, EWR_DATATYPE_STRING, -1);
		...
		// idusuario
		$this->idusuario = new crField('Estado_de_CampaF1as_x_Asesor', 'Estado de Campañas x Asesor', 'x_idusuario', 'idusuario', '`idusuario`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// nombre
		$this->nombre = new crField('Estado_de_CampaF1as_x_Asesor', 'Estado de Campañas x Asesor', 'x_nombre', 'nombre', '`nombre`', 200, EWR_DATATYPE_STRING, -1);
		...
		// asesor
		$this->asesor = new crField('Estado_de_CampaF1as_x_Asesor', 'Estado de Campañas x Asesor', 'x_asesor', 'asesor', '`asesor`', 200, EWR_DATATYPE_STRING, -1);
		...
		// fechatrans
		$this->fechatrans = new crField('Estado_de_CampaF1as_x_Asesor', 'Estado de Campañas x Asesor', 'x_fechatrans', 'fechatrans', '`fechatrans`', 133, EWR_DATATYPE_DATE, 7);
		...
		// idtipificacion
		$this->idtipificacion = new crField('Estado_de_CampaF1as_x_Asesor', 'Estado de Campañas x Asesor', 'x_idtipificacion', 'idtipificacion', '`idtipificacion`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// ATENDIDO
		$this->ATENDIDO = new crField('Estado_de_CampaF1as_x_Asesor', 'Estado de Campañas x Asesor', 'x_ATENDIDO', 'ATENDIDO', '`ATENDIDO`', 131, EWR_DATATYPE_NUMBER, -1);
		...
		// PENDIENTE
		$this->PENDIENTE = new crField('Estado_de_CampaF1as_x_Asesor', 'Estado de Campañas x Asesor', 'x_PENDIENTE', 'PENDIENTE', '`PENDIENTE`', 131, EWR_DATATYPE_NUMBER, -1);
		...
		// TOTAL
		$this->TOTAL = new crField('Estado_de_CampaF1as_x_Asesor', 'Estado de Campañas x Asesor', 'x_TOTAL', 'TOTAL', '`TOTAL`', 20, EWR_DATATYPE_NUMBER, -1);
		...
		// PROCENT
		$this->PROCENT = new crField('Estado_de_CampaF1as_x_Asesor', 'Estado de Campañas x Asesor', 'x_PROCENT', 'PROCENT', '`PROCENT`', 131, EWR_DATATYPE_NUMBER, -1);
		...
		// CALIFICADO
		$this->CALIFICADO = new crField('Estado_de_CampaF1as_x_Asesor', 'Estado de Campañas x Asesor', 'x_CALIFICADO', 'CALIFICADO', '`CALIFICADO`', 131, EWR_DATATYPE_NUMBER, -1);
		...
		// NOINTERESADO
		$this->NOINTERESADO = new crField('Estado_de_CampaF1as_x_Asesor', 'Estado de Campañas x Asesor', 'x_NOINTERESADO', 'NOINTERESADO', '`NOINTERESADO`', 131, EWR_DATATYPE_NUMBER, -1);
		...
		// OTROPROGRAMA
		$this->OTROPROGRAMA = new crField('Estado_de_CampaF1as_x_Asesor', 'Estado de Campañas x Asesor', 'x_OTROPROGRAMA', 'OTROPROGRAMA', '`OTROPROGRAMA`', 131, EWR_DATATYPE_NUMBER, -1);
		...
		// FALLIDA
		$this->FALLIDA = new crField('Estado_de_CampaF1as_x_Asesor', 'Estado de Campañas x Asesor', 'x_FALLIDA', 'FALLIDA', '`FALLIDA`', 131, EWR_DATATYPE_NUMBER, -1);
		...
		// Otras
		$this->Otras = new crField('Estado_de_CampaF1as_x_Asesor', 'Estado de Campañas x Asesor', 'x_Otras', 'Otras', '`Otras`', 131, EWR_DATATYPE_NUMBER, -1);
	...
	function SqlFrom() { // From
		return "`estado_campania_x_asesor_view`";
	}
