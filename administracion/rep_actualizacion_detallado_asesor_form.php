...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>Reporte de Actualización de Asesor</title>
                        ...
                        <div class="row-fluid">
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    <div class="muted pull-left">Reporte de Actualización de Contactos Detallada de Programa por Asesor</div>
                                </div>
                                <div class="block-content collapse in">
                                </div>
                                <form class="form-horizontal" id="frmgestionxprograma" name="formgestionasesor" method="post" action="rep_actualizacion_detallado_asesor_procesar.php">
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <button type="reset" class="btn" onclick="location.href = 'rep_actualizacion_detallado_asesor_form.php'">Cancelar</button>
                                    </div>
                                </form>
                            </div>
                        </div>
