...
<!--##
	...
	var bUserTable = (PROJ.SecType == "Both" || PROJ.SecType == "Use Table");
...
// Language settings
define("EWR_LANGUAGE_FOLDER", "<!--##=sLanguageFolder##-->", TRUE);
...
// General
define("EWR_ROOT_RELATIVE_PATH", "<!--##=PROJ.RootRelativePath##-->", TRUE); // Relative path of app root
...
// Hard-coded admin
define("EWR_ADMIN_USER_NAME", "<!--##=ew_Quote(PROJ.SecLoginID)##-->", TRUE);
define("EWR_ADMIN_PASSWORD", "<!--##=ew_Quote(PROJ.SecPasswd)##-->", TRUE);
...
// Reflow
define("EWR_MOBILE_REFLOW", <!--##=ew_Val(PROJ.GetV("ReflowForMobile"))##-->, TRUE);
