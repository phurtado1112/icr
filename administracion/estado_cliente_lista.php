                        ...
                        <div class="row-fluid">
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    ...
                                    <a href="estado_cliente_crear.php" class="btn btn-small btn-success">Nuevo Estado</a>
                                </div>
                                        ...
                                        if (!isset($estado_cliente)) {
                                            ...
                                            foreach ($estado_cliente as $ec) {
                                                ...
                                                echo"
                                                    ...
                                                    <td>" . '<a href="estado_cliente_editar.php?idestadoscliente=' . $ids . '">Editar</a> ---  <a href="estado_cliente_eliminar.php?idestadoscliente=' . $ids . '">Eliminar</a>' . "</td>
                                                    </tr>";
                                            }
                                        }
                                        ?>
