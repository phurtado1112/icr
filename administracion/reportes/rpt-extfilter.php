...
<div class="accordion ewDisplayTable" id="<!--##=sFormName##-->_SearchGroup">
	<div class="accordion-group">
		<div class="accordion-heading">
			<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#<!--##=sFormName##-->_SearchBody"><!--##@Filters##--></a>
		</div>
		<div id="<!--##=sFormName##-->_SearchBody" class="accordion-body collapse in">
			<div class="accordion-inner">

<div class="ewExtFilter">
...
##-->
<!-- Year selection -->
<div id="r_<!--##=sColDateFldParm##-->" class="ewRow">
<span id="c_<!--##=sColDateFldParm##-->" class="ewCell">
	<span class="ewSearchCaption"><?php echo $ReportLanguage->Phrase("Year"); ?></span>
	<span class="ewSearchOperator">&nbsp;</span>
	<span class="control-group ewSearchField">
	<select name="<!--##=sColDateFldName##-->"<!--##=sPostBack##-->>
<?php
// Set up array
	...
	for (var i = 0; i < nFldCount; i++) {
		if (GetFldObj(arFlds[i])) {
			...
			if (IsExtendedFilter(goFld) && !IsTextFilter(goFld)) {
				...
				//}
##-->
<div id="r_<!--##=gsFldParm##-->" class="ewRow">
<span id="c_<!--##=gsFldParm##-->" class="ewCell">
	<span class="ewSearchCaption"><?php echo $<!--##=gsFldObj##-->->FldCaption() ?></span>
	<span class="ewSearchOperator">&nbsp;</span>
	<span class="control-group ewSearchField"><!--##~SYSTEMFUNCTIONS.FieldSearchLookup(bAutoPostBack)##--></span>
</span>
</div>
<!--##
...
<span id="c_<!--##=gsFldParm##-->" class="ewCell">
	...
	<span class="control-group ewSearchField<!--## if (ew_IsEmpty(sFldSrchOpr2)) { ##--> btw1_<!--##=gsFldParm##--><!--## } ##-->"<!--##=sInitStyle##-->><!--##=SYSTEMFUNCTIONS.FieldSearch2()##--></span>
		<!--## } ##-->
</span>
</div>
<!--##
