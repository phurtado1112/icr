...
$consulta_tipificacion = "SELECT * FROM tipificacion";
                                        ...
                                        if (!isset($tipificacion)) {
                                            ...
                                            foreach ($tipificacion as $t) {
                                                ...
                                                echo"
                                                    ...
                                                    <td>" . '<a href="tipificacion_editar.php?idtipificacion=' . $ids . '">Editar</a> ---  <a href="tipificacion_eliminar.php?idtipificacion=' . $ids . '">Eliminar</a>' . "</td>
                                                    </tr>";
                                            }
                                        }
                                        ?>
