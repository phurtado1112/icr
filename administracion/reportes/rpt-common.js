...
// User level prefix
var pfxUserLevel = ReadReg("HKCU\\Software\\PHPReportMaker\\7.0\\Settings\\General\\UserLevelTableNamePrefix");
if (pfxUserLevel == "") pfxUserLevel = ReadReg("HKCU\\Software\\PHPReportMaker\\6.0\\Settings\\General\\UserLevelTableNamePrefix");
...
function IsFCFChart(typ) {
	return (typ == 20 || typ == 21 || typ == 22);
}

function UseFusionCharts() {
	return ew_GetCtrlById("FusionCharts") != null;
}
