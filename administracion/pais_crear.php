                        ...
                        <div class="row-fluid">
                            <div class="block">
                                ...
                                <div class="block-content collapse in">
                                    <form class="form-horizontal" action="pais_crear_procesar.php" name="formpais" method="post">
                                        <fieldset>
                                            <legend >Ingresar Nuevo País</legend>
                                            <div class="control-group">
                                                <label class="control-label">País</label>
                                                <div class="controls">
                                                    <input type="text" class="span6 typeahead" id="pais" name="pais" autofocus>
                                                </div>
                                            </div>                                            
