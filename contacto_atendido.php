...
$consulta_contactos = "SELECT * FROM transacciones_atendidos_view WHERE idusuario='" . $_SESSION['idusuario'] . "'AND idcampania='" . $_SESSION['idcampania'] . "' order by fecha desc, hora desc";
...
$consulta_cantidad_actualizados = "SELECT count(idtipificacion) as idtipificacion FROM transacciones_tipificacion_view WHERE "
...
$consulta_cantidad_contactos = "SELECT count(idcliente) as total FROM clientes WHERE idasignar='" . $_SESSION['idasignar'] . "'";
    ...
    <body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="nav-collapse collapse">
                        <ul class="nav">
                            ...
                            <li class="active"><a href="contacto_atendido.php">Atendidos</a></li> 
                            <li>
                                <div>
        ...
        <script>
                                        function porclick() {
                                            ...
                                            buscaratendidos(var_numero, var_opcion);
                                        }
