...
// Pie de página
        ...
        while ($fila00 = bd_obtener_fila($res00)) {
            ...
            while ($fila = bd_obtener_fila($res)) {
                $pdf->Cell(75, 6, utf8_decode('Total de Actualizados por Campaña: '), 1, 0, 'L', true);
            ...
            $consulta30 = "select nombre, email, pais
                    ...
                    where idprograma=" . $idprograma . " and idcampania='" . $fila00['idcampania'] . "' and tra.idtipificacion=14  and (fecha >='"
